...
export function ContactContent({ formData, onChange, onSubmit }: ContactContentProps) {
  return (
    <div className="relative z-10 max-w-6xl mx-auto px-4">
      ...
      >
        <p className="text-gray-400 mb-4">
          ...
          <a href="/our-company?tab=docs" className="text-blue-400 hover:text-blue-300 transition-colors duration-300">
            documentation
          </a>{' '}
          or{' '}
...
export default function ContactPage() {
  ...
  return (
    <div className="relative bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] min-h-screen py-20 overflow-hidden">
      ...
      <ContactContent formData={formData} onChange={handleChange} onSubmit={handleSubmit} />
    </div>
  )
}
